...
part 'driving_license_file_state.dart';

class DrivingLicenseFileCubit extends Cubit<DrivingLicenseFileState> {
  DrivingLicenseFileCubit() : super(DrivingLicenseFileInitial());
  ...
  clearState() => emit(DrivingLicenseFileInitial());
}
