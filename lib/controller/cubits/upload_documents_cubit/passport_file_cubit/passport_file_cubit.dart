...
part 'passport_file_state.dart';

class PassportFileCubit extends Cubit<PassportFileState> {
  PassportFileCubit() : super(PassportFileInitial());
  ...
  clearState() => emit(PassportFileInitial());
}
